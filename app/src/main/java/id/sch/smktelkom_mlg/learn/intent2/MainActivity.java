...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.buttonInput).setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                startActivityForResult(new Intent(MainActivity.this, Input.class), REQUEST_CODE);
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if(requestCode==REQUEST_CODE)
        {
            ...
            {
                String nama = data.getStringExtra(Input.NAMA);
                int thnLhr = data.getIntExtra(Input.TAHUN_LAHIR, 0);
